...
const OrderSummary = () => {
  ...
  return (
    <div className="w-full md:w-96 bg-gray-500/5 p-5">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="flex flex-col items-start gap-3">
            ...
            />
            <button className="bg-cyan-600 text-white px-9 py-2 hover:bg-cyan-700">
              Áp dụng
            </button>
          </div>
        </div>
      ...
      <button onClick={createOrder} className="w-full bg-cyan-600 text-white py-3 mt-5 hover:bg-cyan-700">
        Place Order
      </button>
    </div>
  );
